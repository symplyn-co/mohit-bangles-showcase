...
const Footer = () => {
  ...
  Offering a wide range of brass and plastic bangles in different designs, perfect for daily wear and bulk purchase.
</p>
  ...
  Sant Kabir Road, Imitation Market, Rajkot, Gujarat.
              ...
              <li className="flex items-center gap-3">
                ...
                <span>+91 76002 34489</span>
              </li>
              <li className="flex items-center gap-3">
                <i className="fas fa-envelope text-primary" />
                <span>info@mohitbangles.com</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-primary-foreground/10 mt-12 pt-8 text-center">
          <p className="font-body text-xs text-primary-foreground/50">
            &copy; {new Date().getFullYear()} Mohit Bangles. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
